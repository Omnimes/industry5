...
export const TextRevealCard = ({
  ...
  return (
    ...
    >
      ...
      {desc && <p className="text-muted-foreground mx-auto mb-8 max-w-screen-xl px-0 pb-3 text-lg md:text-center md:text-xl">
        {desc}
      </p>}
      {/* <hr className="my-8" /> */}
    </div>
...
export const TextRevealCardDouble = ({
  ...
  return (
    <div
      className={cn(
        "bg-background relative w-full overflow-hidden py-10",
        className
      )}
    >
      <div className=" w-fit max-w-screen-xl overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)] md:mx-auto md:mb-2">
