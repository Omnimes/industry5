    ...
    return (
        <section id="industry" className="mx-auto max-w-5xl px-4 py-12 md:py-24">
            <div className="mx-auto mb-16 w-full text-left md:text-center">
                ...
                <p data-aos="fade-up" data-aos-delay="300" className="text-muted-foreground px-0 text-lg md:text-xl">{t("p1")}</p>
            </div>
            <section className="mx-auto lg:flex lg:justify-center">
                <div
                    ...
                    <div className="lg:w-1/2">
                        <Image data-aos="fade-left" data-aos-anchor-placement="top-bottom" data-aos-delay="500" src={"/images/2.png"} alt={t('altImg')} width={1260} height={1260} className="h-64 object-cover lg:h-full" />
                    </div>
