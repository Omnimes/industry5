    ...
    <NavigationMenu>
      <NavigationMenuList className="hidden md:flex md:space-x-4">
        ...
        <NavigationMenuItem>
          <Link
            href="/blog"
            aria-label={taria("footerAria") + "blog"}
            rel="noreferrer noopener"
            legacyBehavior
            passHref
          >
            <NavigationMenuLink className="font-medium">{t("blog")}</NavigationMenuLink>
          </Link>
        </NavigationMenuItem>
        <NavigationMenuItem>
          <Link
            href="/contact"
            aria-label={taria("footerAria") + t("contact")}
            rel="noreferrer noopener"
            legacyBehavior
            passHref
          >
            <NavigationMenuLink className="font-medium">{t("contact")}</NavigationMenuLink>
          </Link>
        </NavigationMenuItem>
      </NavigationMenuList>
    </NavigationMenu>
