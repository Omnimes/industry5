        ...
        <section className="mx-auto max-w-5xl px-4 py-12 md:py-24">
            ...
            <div className="grid max-w-screen-lg gap-8 sm:mx-auto lg:grid-cols-2 ">
                <div className="grid grid-cols-2 gap-5">
                    <Image src={"/images/4.png"} alt={t("alt1")} width={1260} height={750} className="col-span-2 h-56 w-full rounded object-cover shadow-lg" />
                    <Image src={"/images/5.png"} alt={t("alt2")} width={1260} height={750} className="h-48 w-full rounded object-cover shadow-lg" />
                    <Image src={"/images/6.png"} alt={t("alt3")} width={1260} height={750} className="h-48 w-full rounded object-cover shadow-lg" />
                </div>
