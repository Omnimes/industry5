...
const font = fetch(new URL("assets/fonts/CalSans-SemiBold.ttf", import.meta.url)).then((res) =>
  res.arrayBuffer()
)
            ...
            >
              ...
              <defs>
                <clipPath id="clip0_481_12">
                  <rect width="1200" height="630" fill="white" transform="translate(0 0.695312)" />
                </clipPath>
