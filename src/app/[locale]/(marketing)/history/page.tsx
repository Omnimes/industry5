...
export default async function HistoryPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <main className="mx-auto w-full max-w-screen-xl px-4 py-12 md:py-24">
      <TextRevealCardDouble text={t("titlePart1")} textPart={t("titlePart2")} />
      ...
      <article className="text-muted-foreground mb-6 px-0 lg:text-lg">
        ...
        <ul className="mb-12 list-inside list-disc space-y-1 px-0">
          <li>
            <strong>{t("strong1")}</strong> {t("list1")}
          </li>
          <li>
            <strong>{t("strong2")}</strong> {t("list2")}
          </li>
          <li>
            <strong>{t("strong3")}</strong> {t("list3")}
          </li>
          <li>
            <strong>{t("strong4")}</strong> {t("list4")}
          </li>
        </ul>
        ...
        <ul className="mb-12 list-inside list-disc space-y-1 px-0">
          <li>
            <strong>{t("strong13")}</strong> {t("list13")}
          </li>
          <li>
            <strong>{t("strong14")}</strong> {t("list14")}
          </li>
          <li>
            <strong>{t("strong15")}</strong> {t("list15")}
          </li>
          <li>
            <strong>{t("strong16")}</strong> {t("list16")}
          </li>
        </ul>
        ...
        <ul className="mb-12 list-inside list-disc space-y-1 px-0">
          <li>
            <strong>{t("strong17")}</strong> {t("list17")}
          </li>
          <li>
            <strong>{t("strong18")}</strong> {t("list18")}
          </li>
          <li>
            <strong>{t("strong19")}</strong> {t("list19")}
          </li>
          <li>
            <strong>{t("strong20")}</strong> {t("list20")}
          </li>
        </ul>
        ...
        <ul className="mb-12 list-inside list-disc space-y-1 px-0">
          <li>
            <strong>{t("strong5")}</strong> {t("list5")}
          </li>
          <li>
            <strong>{t("strong6")}</strong> {t("list6")}
          </li>
          <li>
            <strong>{t("strong7")}</strong> {t("list7")}
          </li>
          <li>
            <strong>{t("strong8")}</strong> {t("list8")}
          </li>
          <li>
            <strong>{t("strong9")}</strong> {t("list9")}
          </li>
          <li>
            <strong>{t("strong10")}</strong> {t("list10")}
          </li>
          <li>
            <strong>{t("strong11")}</strong> {t("list11")}
          </li>
          <li>
            <strong>{t("strong12")}</strong> {t("list12")}
          </li>
        </ul>
