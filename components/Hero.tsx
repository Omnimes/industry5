            ...
            <div className="z-[2] space-y-2">
                <div className="mx-auto max-w-5xl">
                    <div className="text-center">
                        <h1 className="bg-gradient-to-r from-neutral-300 to-stone-400 bg-clip-text font-heading text-4xl 
                        ...
                        <div className="mt-10 flex flex-wrap items-center justify-center gap-x-6">
                            <Button asChild className="bg-gradient-to-r from-slate-600 to-slate-800  text-white">
                                <Link locale="pl" href="#industry">{t("button1")}</Link>
                            </Button>
                            <Button variant="link" asChild className="text-white">
                                <Link locale="pl" href="/eu-applications">{t("button2")}<ArrowRightIcon className="ml-2 size-4" /></Link>
                            </Button>
                        </div>
                    </div>
                </div>
